...
// Created: 五 7月  7 19:20:49 2017 (+0800)
// Last-Updated: 五 7月  7 19:57:30 2017 (+0800)
//           By: Hongyi Wu(吴鸿毅)
//     Update #: 5
...
int main(int argc, char *argv[])
{
  ...
  TH1I *energykeV = new TH1I("energykeV","",5000,0,10000);//2048,0,32768
  energykeV->GetXaxis()->SetTitle("keV");
  ...
  for (Long64_t entry = 0; entry < TotalEntry; ++entry)
      ...
      if(tempenergy > 0)
	{
	  ...
	  energyQ->Fill(tempenergy);

	  energykeV->Fill(tempenergy*0.0426472-3.81777);
	}
